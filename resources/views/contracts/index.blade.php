                                ...
                                @foreach($contracts as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/contacts/' . $item->id . '/edit') }}" title="Edit Contracts"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
